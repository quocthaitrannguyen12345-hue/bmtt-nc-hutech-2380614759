...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_cipher.setGeometry(QtCore.QRect(100, 190, 381, 71))
        self.txt_cipher.setObjectName("txt_cipher")
        self.txt_plaintext = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_plaintext.setGeometry(QtCore.QRect(100, 50, 381, 71))
        self.txt_plaintext.setObjectName("txt_plaintext")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(190, 0, 161, 31))
        font = QtGui.QFont()
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 190, 61, 16))
        self.label_4.setObjectName("label_4")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(330, 320, 75, 23))
        ...
        self.txt_key.setGeometry(QtCore.QRect(100, 130, 381, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Rail Fair Cipher"))
